...
# Sigmoid cooling schedule
coolingschedule <- function(i, n) {
  steepness <- 12  # controls steepness of the sigmoid curve
  midpoint <- n / 2  # roughly the iteration where temperature is halfway
...
# Gibbs sampler with sigmoid cooling schedule
for (i in 2:niter) {
